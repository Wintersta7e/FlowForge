...
public sealed class MwMercuryDroplet : Control
{
    ...
    public static readonly StyledProperty<Point> SourceProperty =
        AvaloniaProperty.Register<MwMercuryDroplet, Point>(nameof(Source));

    public static readonly StyledProperty<Point> TargetProperty =
        AvaloniaProperty.Register<MwMercuryDroplet, Point>(nameof(Target));

    public static readonly StyledProperty<double> ProgressProperty =
        AvaloniaProperty.Register<MwMercuryDroplet, double>(nameof(Progress));
